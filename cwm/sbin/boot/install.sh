if /sbin/ext/busybox [ ! -f /system/cfroot/release-104-LPH- ]; 
then
# Remount system RW
...
#    /sbin/ext/busybox dd if=/dev/block/mmcblk0p5 of=/system/app/Superuser.apk skip=7000000 seek=0 bs=1 count=843503
...
#    /sbin/ext/busybox dd if=/dev/block/mmcblk0p5 of=/system/app/CWMManager.apk skip=6500000 seek=0 bs=1 count=331047
...
# Once be enough
    ...
    echo 1 > /system/cfroot/release-104-LPH- 
